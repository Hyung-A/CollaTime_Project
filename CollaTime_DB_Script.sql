...
DROP TABLE IF EXISTS CT_MEMBER CASCADE;
...
(
    CT_MEMBER_NO    INT AUTO_INCREMENT PRIMARY KEY COMMENT '회원번호',
    CT_MEMBER_ID    VARCHAR(255) NOT NULL COMMENT '아이디',
    CT_MEMBER_PWD    VARCHAR(255) NOT NULL COMMENT '비밀번호',
    CT_MEMBER_EMAIL    VARCHAR(50) NOT NULL COMMENT '이메일',
    CT_MEMBER_NAME    VARCHAR(20) NOT NULL COMMENT '이름',
    CT_MEMBER_NICKNAME    VARCHAR(20) NOT NULL COMMENT '닉네임',
    CT_MEMBER_PICTURE    VARCHAR(50) NOT NULL COMMENT '프로필 그림',
    CT_MEMBER_COLOR    VARCHAR(50) NOT NULL COMMENT '프로필 색',
    CT_MEMBER_ROLE    VARCHAR(10) NOT NULL COMMENT '역할'
...
(
   PROJECT_NO INT PRIMARY KEY AUTO_INCREMENT COMMENT '프로젝트 번호',
    ...
    PROJECT_CATEGORY_CODE VARCHAR(10) NOT NULL COMMENT '프로젝트 카테고리 코드',
    PROJECT_START_DATE VARCHAR(255) NOT NULL COMMENT '프로젝트 시작 일자',
    PROJECT_END_DATE VARCHAR(255) NOT NULL COMMENT '프로젝트 종료 일자',
    RPOJECT_SUMMARY VARCHAR(255) NOT NULL COMMENT '프로젝트 개요',
    PROJECT_PURPOSE VARCHAR(255) NOT NULL COMMENT '프로젝트 목적',
    PRODUCTOR_NO INT NOT NULL COMMENT '생성자 회원 번호',
    CONSTRAINT FK_PRODUCTOR_NO FOREIGN KEY (PRODUCTOR_NO) REFERENCES CT_MEMBER(CT_MEMBER_NO) ON DELETE CASCADE,
    CONSTRAINT FK_CATEGORY_CODE FOREIGN KEY (PROJECT_CATEGORY_CODE) REFERENCES CATEGORY(PROJECT_CATEGORY_CODE) ON DELETE CASCADE
...
(
   PROJECT_NO INT NOT NULL COMMENT '프로젝트 번호',
    CT_MEMBER_NO INT NOT NULL COMMENT '회원 번호',
   RANDOM_JOIN_CODE VARCHAR(10) NOT NULL COMMENT '참가 랜덤 코드',
    CONSTRAINT FK_PROJECT_NO FOREIGN KEY (PROJECT_NO) REFERENCES PROJECT(PROJECT_NO) ON DELETE CASCADE,
    CONSTRAINT FK_JOIN_MEMBER_NO FOREIGN KEY (CT_MEMBER_NO) REFERENCES CT_MEMBER(CT_MEMBER_NO) ON DELETE CASCADE
...
(
    ...
    CT_MEMBER_NO    INT NOT NULL COMMENT '회원번호',
    ANSWER_CONTENT    VARCHAR(255) COMMENT '답변내용',
    CONSTRAINT FK_MEMBER_NO FOREIGN KEY (CT_MEMBER_NO) REFERENCES CT_MEMBER (CT_MEMBER_NO) ON DELETE CASCADE
...
-- 프로젝트 테이블 데이터 삽입
INSERT INTO PROJECT VALUES (0, "계산기 프로그램 개발", "CT5", 2023-11-15, 2023-12-20, "계산기 프로그램 어플리케이션 만들기", "복잡한 기능은 삭제된 간단하고 사용하기 쉬운 계산기 기능만 들어간 가장 기본적인 계산기 어플리케이션을 만든다.", "1" );
INSERT INTO PROJECT VALUES (0, "엽서 판매 웹사이트 제작", "CT4", 2024-02-01, 2024-04-20, "엽서 판매 웹 사이트 제작하기", "사진 취미러들의 사진을 받아 엽서로 제작하여 사진 입문자들의 사진도 대중들에게 사랑받을 수 있는 기회를 제공한다.", "2" );

-- 프로젝트 참가자 테이블 데이터 삽입
INSERT INTO JOIN_PROJECT VALUES(1, "1", "ADF182WE");
INSERT INTO JOIN_PROJECT VALUES(1, "1", "GEF864SD");
INSERT INTO JOIN_PROJECT VALUES(1, "2", "WDS648HD");
INSERT INTO JOIN_PROJECT VALUES(1, "3", "HDW234GH");
INSERT INTO JOIN_PROJECT VALUES(2, "2", "GSE846DS");
INSERT INTO JOIN_PROJECT VALUES(2, "3", "KFG697GK");
INSERT INTO JOIN_PROJECT VALUES(2, "4", "LWO465DJ");
INSERT INTO JOIN_PROJECT VALUES(2, "1", "NKJ357DL");
