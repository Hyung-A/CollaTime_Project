...
(
    ...
    CONSTRAINT FK_PRODUCTOR_NO FOREIGN KEY (PRODUCTOR_NO) REFERENCES CT_USER(CT_USER_NO) ON DELETE CASCADE,
...
(
    ...
    CONSTRAINT FK_JOIN_USER_NO FOREIGN KEY (CT_USER_NO) REFERENCES CT_USER(CT_USER_NO) ON DELETE CASCADE
