...
-- 프로젝트 테이블 데이터 삽입
INSERT INTO PROJECT VALUES (1, "계산기 프로그램 개발", "CT5", "2023-11-15", "2023-12-20", "계산기 프로그램 어플리케이션 만들기", "복잡한 기능은 삭제된 간단하고 사용하기 쉬운 계산기 기능만 들어간 가장 기본적인 계산기 어플리케이션을 만든다.", "1" );
INSERT INTO PROJECT VALUES (2, "엽서 판매 웹사이트 제작", "CT4", "2024-02-01", "2024-04-20", "엽서 판매 웹 사이트 제작하기", "사진 취미러들의 사진을 받아 엽서로 제작하여 사진 입문자들의 사진도 대중들에게 사랑받을 수 있는 기회를 제공한다.", "2" );
